...
sealed class NavigationItem(val route: String, val icon_filled: Int, val icon_outline: Int, val title: String) {
    object Scan : NavigationItem(
        ...
        icon_filled = R.drawable.ic_hicon_scan_6,
        icon_outline = R.drawable.ic_hicon_scan_6,
        title = "Scan"
    )

    object Logins : NavigationItem(
        route = Screen.LoginsScreen.route,
        icon_filled = R.drawable.ic_hicon_password_1,
        icon_outline = R.drawable.ic_hicon_password_1,
        title = "Logins"
    )
